...
//    implements CellAttribute ,CellSpan  {
      implements CellAttribute ,CellSpan ,ColoredCell ,CellFont, CellAlign {
  ...
  public void addColumn() {
    ...
    int numColumns = oldSpan.length>0?oldSpan[0].length:0;
  ...
  public void setSize(Dimension size) {
    ...
    align = new int[rowSize][columnSize];
    initValue();
  }
